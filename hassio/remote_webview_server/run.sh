...
export FRAME_PROCESSING_CONCURRENCY="$(get_opt frame_processing_concurrency 2)"
export WS_HIGH_WATER_BYTES="$(get_opt ws_high_water_bytes 524288)"
export IDLE_FRAME_INTERVAL_MS="$(get_opt idle_frame_interval_ms 2000)"
export ACTIVE_AFTER_INTERACTION_MS="$(get_opt active_after_interaction_ms 30000)"
